    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-6">
            <div class="card-header">
                <h5 class="card-tile mb-0">Edit Post</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.post.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input readonly id="slug" type="text" class="form-control" placeholder="slug..." name="slug"
                    ...
                    <div class="mb-4">
                        <div class="col form-check form-switch mb-2">
                            ...
                            <input {{ $post->is_published ? 'checked' : '' }} name="is_published" value="1" class="form-check-input" type="checkbox"
                    ...
                    <div class="row mb-4">
                        <div class="col">
                            ...
                            <a class="fancybox" href="{{ asset($post->image_url) }}"><img width="40px" class="mt-2" src="{{ asset($post->image_url) }}" alt=""></a>
                        </div>
                        <div class="col">
